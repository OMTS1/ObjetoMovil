...
import gnz.backend.Objetos.ComunicarArduino;
...
//        System.out.println("PRECIONANDO(" + evt.getX() + "," + evt.getY() + ")");
    ...
    private void analyse(){
        try {
            CommunicationParser parser = new CommunicationParser(new CommunicationLexer(new StringReader(commandsArea.getText())));
            parser.parse();
            if(parser.getMovement() != null){
                sendData(parser.getMovement());
            } else{
     ...
     */
    private void sendData(Movement movement){
        switch(movement.getType()){
            case BASE:
                RFDriver.sendData(movement.getType().ordinal() +"|"+ movement.getMotor().ordinal() +"|"+ movement.getDistance() +"|"+ movement.getSpeed().ordinal() +"|"+ movement.getOrientation1().ordinal() +"|");
                break;
            case STRAIGHT:
                RFDriver.sendData(movement.getType().ordinal() +"|"+ movement.getDistance() +"|"+ movement.getSpeed().ordinal() +"|"+ movement.getOrientation1().ordinal() +"|");
                break;
            case DIAGONAL:
                RFDriver.sendData(movement.getType().ordinal() +"|"+ movement.getDistance() +"|"+ movement.getSpeed().ordinal() +"|"+ movement.getAngle() +"|");
                break;
            case CURVED:
                RFDriver.sendData(movement.getType().ordinal() +"|"+ movement.getRadio() +"|"+ movement.getSpeed().ordinal() +"|"+ movement.getOrientation1().ordinal() +"|"+ movement.getOrientation2().ordinal() +"|");
                break;
        }
        messagesArea.setText(messagesArea.getText() + "Enviando: " + commandsArea.getText() + "\n");
